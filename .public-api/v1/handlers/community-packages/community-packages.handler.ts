...
type InstallPackageRequest = AuthenticatedRequest<{}, {}, { name: string; version?: string; verify?: boolean }>;

type UpdatePackageRequest = AuthenticatedRequest<{ name: string }, {}, { version?: string; verify?: boolean }>;
