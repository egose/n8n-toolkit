...
const handleError = (error: unknown) => {
  if (error instanceof DataTableColumnNameConflictError || error instanceof DataTableSystemColumnNameConflictError) {
...
const dataTableColumnsHandlers: DataTableColumnsHandlers = {
  ...
  createDataTableColumn: [
    ...
    async (req, res) => {
      ...
      try {
        const column = await Container.get(DataTableService).addColumn(dataTableId, projectId, payload.data);
