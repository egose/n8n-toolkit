## [0.13.0](https://github.com/egose/n8n-toolkit/compare/v0.12.0...v0.13.0) (2026-08-13)

### Features

* harden n8n client transport, responses, and packaging ([09f5b38](https://github.com/egose/n8n-toolkit/commit/09f5b38aaf3320d3252d64c383df143e62d3b8fa))
* **n8n-sync:** add durable sync ordering and replay protection ([aac66c4](https://github.com/egose/n8n-toolkit/commit/aac66c4dd0aa7946a47bc4e8dbb6e23acebb3d8e))

### Documentation

* add n8n client remediation task plan ([87999ae](https://github.com/egose/n8n-toolkit/commit/87999aef933c08c8e6fa6f655e2761290a1daf7f))
* capture n8n client remediation scope and verification plan ([d70e04f](https://github.com/egose/n8n-toolkit/commit/d70e04f6637dcdecf324109f954821e61c0d49b4))
