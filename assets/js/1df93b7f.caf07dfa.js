...
function Packages({ isDarkTheme }) {
    const items = [
        {
            name: 'n8n-client',
            tagline: 'Typed TypeScript client for the n8n Public API v1.',
            description: 'Manage workflows, executions, credentials, projects, and the rest of the n8n API through resource-scoped handlers built on native fetch with zero runtime dependencies.',
        ...
        },
        {
            ...
            description: 'Two self-contained CommonJS hook bundles — a publisher on the source and a subscriber on each target — keep workflows, credentials, and opt-in executions mirrored across instances with HMAC or bearer auth and no runtime dependencies.',
                ...
                /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsxs)("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsx)("h2", {
                            ...
                            children: "One toolkit, two focused packages."
                        }),
                        /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsx)("p", {
                            className: `mt-4 text-base leading-7 ${isDarkTheme ? 'text-slate-300' : 'text-slate-600'}`,
                            children: "Both packages are dependency-free, native-fetch based, and stay close to the n8n surface they wrap — a typed client for driving the Public API, and hook bundles for keeping multiple instances in sync."
                        })
                    ]
                }),
                /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsx)("div", {
                    ...
                    children: items.map((item)=>{
                        ...
                        return /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsxs)(_docusaurus_Link__rspack_import_2/* ["default"] */.A, {
                            className: `group rounded-3xl border p-7 no-underline shadow-sm transition hover:-translate-y-0.5 hover:shadow-md ${isDarkTheme ? `border-slate-800 bg-slate-900 ${a.ring}` : `border-slate-200 bg-white ${a.ring}`}`,
                            to: item.href,
                            children: [
                                /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsxs)("div", {
                                    className: `text-sm font-semibold uppercase tracking-[0.2em] ${a.badge}`,
                                    children: [
                                        "@egose/",
                                        item.name
                                    ]
                                ...
                                /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsxs)("div", {
                                    className: `mt-5 text-sm font-semibold ${a.badge}`,
                                    children: [
                                        item.link,
                                        " →"
                                    ]
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsx)(_theme_Layout__rspack_import_4/* ["default"] */.A, {
        ...
        children: /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsxs)("main", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsx)(Packages, {
                    isDarkTheme: isDarkTheme
                }),
