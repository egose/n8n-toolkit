...
var site_docs_example_execution_monitoring_mdx_9ab_namespaceObject = JSON.parse('{"id":"example/execution-monitoring","title":"Execution Monitoring","description":"This example covers listing, filtering, inspecting, stopping, and retrying executions using the ExecutionClient.","source":"@site/docs/example/execution-monitoring.mdx","sourceDirName":"example","slug":"/example/execution-monitoring","permalink":"/example/execution-monitoring","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":2,"frontMatter":{"sidebar_label":"Execution Monitoring","sidebar_position":2},"sidebar":"example","previous":{"title":"Workflow Management","permalink":"/example/workflow-management"},"next":{"title":"Credential Management","permalink":"/example/credential-management"}}')
