...
var site_docs_example_credential_management_mdx_e39_namespaceObject = JSON.parse('{"id":"example/credential-management","title":"Credential Management","description":"This example covers creating, testing, updating, transferring, and deleting credentials using the CredentialHandle.","source":"@site/docs/example/credential-management.mdx","sourceDirName":"example","slug":"/example/credential-management","permalink":"/example/credential-management","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":3,"frontMatter":{"sidebar_label":"Credential Management","sidebar_position":3},"sidebar":"example","previous":{"title":"Execution Monitoring","permalink":"/example/execution-monitoring"},"next":{"title":"Project Organization","permalink":"/example/project-organization"}}')
