...
The client uses Node.js 22+ built-in `fetch`. No axios, no node-fetch, no extra packages to audit or maintain.
...
- **Consistent** — same patterns across all 16 resources
